...
def stock_summary(db):
    stk = db.stock.data
    sector = stk['bscs']['sector']
    industry = stk['bscs']['industry']
    summary = html.Div(
                [
                    # Row 1
                    html.Div(
                        [
                            html.H5(stk['bscs']['name']),
                            html.Div([html.H6(sector),
                                       html.H6(industry)
                                    ]),
                            html.Div([html.H6(stk['bscs']['mcap']),
                                       html.H6(stk['bscs']['outstanding_shares']),
                                    ]),
                        ]),
