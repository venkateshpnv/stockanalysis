...
CUR_REVENUE_SLOPE_Q=0
CUR_REVENUE_SLOPE_Q_ERROR=0
FUTURE_REVENUE_SLOPE_Q=0
FUTURE_REVENUE_SLOPE_Q_ERROR=0
CUR_REVENUE_CQGR=0
FUTURE_REVENUE_CQGR=0
CUR_FUTURE_REVENUE_CQGR=0
REVENUE_ELBOW_POINT_Q=0
REVENUE_PRE_ELBOW_SLOPE_Q=0
REVENUE_POST_ELBOW_SLOPE_Q=0
# Diff percent change between post elbow and pre elbow slopes.
# It gives a good measure of future growth rate starting from the elbow point
REVENUE_ELBOW_SLOPE_PERCENT_CHANGE_Q=0

REVENUE_SLOPE_A=0
REVENUE_SLOPE_A_ERROR=0
FUTURE_REVENUE_SLOPE_A=0
FUTURE_REVENUE_SLOPE_A_ERROR=0
PAST_REVENUE_CAGR=0
FUTURE_REVENUE_CAGR=0
PAST_FUTURE_REVENUE_CAGR=0
REVENUE_ELBOW_POINT_A=0
REVENUE_PRE_ELBOW_SLOPE_A=0
REVENUE_POST_ELBOW_SLOPE_A=0
REVENUE_ELBOW_SLOPE_PERCENT_CHANGE_A=0
