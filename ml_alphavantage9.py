...
if __name__ == "__main__":
    ...
    for stk in stocks:
        ...
        #processes[i%num_processes] = multiprocessing.Process(target=process_symbol, args=(sem, stk['bscs']['symbol'], cpu_affinity, request_times))
        #processes[i%num_processes].start()
        process_symbol(sem, stk['bscs']['symbol'], cpu_affinity, request_times)
        i = i + 1
